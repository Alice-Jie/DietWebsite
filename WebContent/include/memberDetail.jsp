...
<form class="layui-form" method="post" action="fore_updateMemberInfo">
    <!-- 会员性别 -->
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="member.Email" value="${member.email}" required lay-verify="required|email"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="member.phone" value="${member.phone}" required lay-verify="required|phone"
